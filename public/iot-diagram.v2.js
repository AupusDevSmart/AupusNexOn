...
var COMPONENT_TYPES = {
    ...
    ton1: {
        ...
        fields: [
            ...
            { key: 'din_gp0', label: 'Mapa das entradas BI (placa V1)', type: 'select', options: [['', 'Padrão da placa V1: X12-1..6 = d1..d6 (GP1-GP6) — confirmado em bancada 22/09/2026'], ['true', 'GP0-GP5 (NÃO usar na V1: GP0 não é entrada e fica preso em 1)']] },
        ]
    },
    ton2: {
