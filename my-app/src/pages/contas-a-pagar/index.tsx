...
// Tipos compatíveis com a interface do modal
interface Conta {
  id: string;
  vencimento: string;
  descricao: string;
...
const allContas: Conta[] = [
  {
    ...
    observacoes: 'Aluguel mensal do escritório na Rua das Flores, 123. Vencimento todo dia 10.'
  },
  {
    id: '2',
    ...
    observacoes: 'Pacote empresarial com 500MB de internet + telefonia fixa e móvel.'
  },
  {
    id: '3',
    ...
    observacoes: 'Renovação anual das licenças Microsoft 365 para 50 usuários. Venceu há 3 dias.'
  },
  {
    id: '4',
    ...
    contaBanco: 'Banco do Brasil - Conta Corrente (123456-7)',
    valorPago: 480.75,
    observacoes: 'Conta de energia do mês de março. Pago via débito automático conforme programado.'
  },
  {
    id: '5',
    ...
    observacoes: 'Primeira parcela da consultoria para implementação do novo sistema de gestão. Projeto previsto para 3 meses.'
  },
  {
    id: '6',
    ...
    formaPagamento: 'pix',
    contaBanco: 'Santander - Conta Empresarial (789012-3)',
    observacoes: 'Compra mensal de materiais: papel A4, canetas, produtos de limpeza e café para a copa.'
  },
  {
    id: '7',
    ...
    contaBanco: 'Itaú - Conta Corrente (456789-0)',
    valorPago: 890.00,
    observacoes: 'Seguro empresarial cobrindo equipamentos, responsabilidade civil e incêndio. Pago antecipadamente.'
  },
  {
    id: '8',
    ...
    formaPagamento: 'pix',
    contaBanco: 'Banco do Brasil - Conta Corrente (123456-7)',
    observacoes: 'Manutenção preventiva dos computadores e impressoras. Atrasado há 2 dias - entrar em contato.'
  }
];
