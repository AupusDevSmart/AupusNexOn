...
#define GATEWAY_IP      "192.168.0.106"
#define GATEWAY_PORT    502
#define GATEWAY_TIMEOUT 2000

const uint8_t TCP_INVERTER_IDS[] = {2, 1};
...
static bool _read_tcp_inv_0_raw(uint16_t *buf) {
    ...
    {
        uint16_t tmp0[50];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 2, 0x04, 4999, 50, tmp0)) {
    ...
    {
        uint16_t tmp1[40];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 2, 0x04, 5049, 40, tmp1)) {
    ...
    {
        uint16_t tmp2[30];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 2, 0x04, 5089, 30, tmp2)) {
    ...
    {
        uint16_t tmp3[35];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 2, 0x04, 5119, 35, tmp3)) {
    ...
    {
        uint16_t tmp4[18];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 2, 0x04, 7012, 18, tmp4)) {
...
static void _sample_tcp_inv_0() {
    ...
    _tds0.samples++;
    _tds0.valid = true;
    Serial.printf("[TCP-INV] Inversor(id2) #%d: ", _tds0.samples);
...
static bool _read_tcp_inv_1_raw(uint16_t *buf) {
    ...
    {
        uint16_t tmp0[50];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 1, 0x04, 4999, 50, tmp0)) {
    ...
    {
        uint16_t tmp1[40];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 1, 0x04, 5049, 40, tmp1)) {
    ...
    {
        uint16_t tmp2[30];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 1, 0x04, 5089, 30, tmp2)) {
    ...
    {
        uint16_t tmp3[35];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 1, 0x04, 5119, 35, tmp3)) {
    ...
    {
        uint16_t tmp4[18];
        if (!_modbus_tcp_read("192.168.0.106", 502, 2000, 1, 0x04, 7012, 18, tmp4)) {
...
static void _sample_tcp_inv_1() {
    ...
    _tds1.samples++;
    _tds1.valid = true;
    Serial.printf("[TCP-INV] Inversor(id1) #%d: ", _tds1.samples);
    Serial.printf("vab=%.2f ", v_vab);
    Serial.printf("vbc=%.2f ", v_vbc);
    Serial.printf("vca=%.2f ", v_vca);
    Serial.printf("ia=%.2f ", v_ia);
