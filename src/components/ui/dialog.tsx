    ...
    <DialogPortal container={fullscreenContainer ?? undefined}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed inset-y-0 right-0 z-[9999] grid w-full max-w-lg gap-4 overflow-y-auto rounded-l-2xl border-l bg-background p-6 shadow-2xl duration-200 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-muted-foreground/25 hover:[&::-webkit-scrollbar-thumb]:bg-muted-foreground/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
          className
        )}
        {...props}
      >
