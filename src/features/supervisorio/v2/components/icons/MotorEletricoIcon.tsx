/**
 * MOTOR ELÉTRICO ICON
 * Silhueta de motor (desenho antigo, restaurado) — SVG inline preenchido,
 * recolorível via `color` (usa a cor do tema no unifilar). Serializável no export.
 */

import React from 'react';

interface MotorEletricoIconProps {
  width?: number;
  height?: number;
  color?: string;
  strokeWidth?: number;
...
export const MotorEletricoIcon: React.FC<MotorEletricoIconProps> = ({
  width = 80,
  height = 80,
  color = 'currentColor',
  className = '',
