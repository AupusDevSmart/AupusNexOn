...
export function SinopticoIndicadores({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2">
      ...
      <Card
        className={`cursor-pointer transition-all hover:shadow-md h-30 ${
        ...
        <CardContent className="p-2 h-full flex items-center">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Alarmes</div>
              {indicadores.alarmes > 0 && (
        ...
        <CardContent className="p-2 h-full flex items-center">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Urgências</div>
              {indicadores.urgencias > 0 && (
                <Badge variant="destructive" className="text-xs mt-1">
                  URGENTE!
                </Badge>
